...
class Activity extends amplify_core.Model {
  ...
  const Activity._internal({required this.id, required activityName, trip, activityImageUrl, activityImageKey, required activityDate, activityTime, required category, createdAt, updatedAt}): _activityName = activityName, _trip = trip, _activityImageUrl = activityImageUrl, _activityImageKey = activityImageKey, _activityDate = activityDate, _activityTime = activityTime, _category = category, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Activity({String? id, required String activityName, Trip? trip, String? activityImageUrl, String? activityImageKey, required amplify_core.TemporalDate activityDate, amplify_core.TemporalTime? activityTime, required ActivityCategory category}) {
  ...
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.indexes = [
      ...
      amplify_core.ModelIndex(fields: const ["tripID", "activityName"], name: "activitiesByTripIDAndActivityName")
    ];
